...
class Admin extends BaseController
{
   ...
   public function login()
   {
      ...
      if (isset($_POST['submit'])) {
         ...
         if (password_verify($password, $this->user->get_hash($username)) == false) {
            $errors[] = 'Wrong username or pasword';
         }
   ...
   public function reset()
   {
      ...
      if (isset($_POST['submit'])) {
         ...
         if (count($errors) == 0) {
            ...
            $mail->Body = "<p>To change your password please click <a href='http://localhost:8000/admin/change_apssword/$token'>this link</a></p>";
   ...
   public function change_password($token)
   {
      ...
      if (isset($_POST['submit'])) {
         $token = htmlspacialchars($_POST['token']);
         $password = \htmlspecialchars($_POST['password']);
