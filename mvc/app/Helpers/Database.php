...
{
   /**
    * Array of saved databases for reusing
    *
    * @var array
    */
   ...
   public static function get($config) {
      ...
      // Setting Database into $instance to avoid duplication
      self::$instance[$id] = $instance;

      // reutrn the pdo instance
      return $instance;
   }
    ...
    * @return array           return an array of reecords
    */
